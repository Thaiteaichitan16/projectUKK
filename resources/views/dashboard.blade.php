...
>
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="../assets/img/favicon/buku.png" />
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
              ...
              <ul class="menu-sub">
                ...
                {{-- <li class="menu-item">
                  <a href="{{url('datarelasi')}}" class="menu-link">
                    <div data-i18n="Fluid">Data Relasi</div>
                  </a>
                </li> --}}
                {{-- <li class="menu-item">
                  <a href="{{url('g')}}" class="menu-link">
            ...
            <li class="menu-header small text-uppercase">
              <span class="menu-header-text">Data Account</span>
            </li>
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-semibold d-block">Wildan.Ads</span>
                ...
                <div class="col-lg-8 mb-4 order-0">
                  <div class="card">
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-7">
                        <div class="card-body">
                          <h5 class="card-title text-primary">Welcome To Our Toko Buku! 🎉</h5>
                          <p class="mb-4">
                            Kamu Bisa<span class="fw-bold"> Sepuasnya</span> Untuk Membeli Buku.
                          </p>
                    ...
                    <div class="col-lg-4 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          {{-- <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i> +23.80%</small> --}}
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-4 col-md-12 col-6 mb-4">
